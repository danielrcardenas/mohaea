...
public class NSEAFactory<T,R> {
	...
	public PopulationSearch<T,R> HAEA( NSHaeaStep<T,R> step, Predicate<Tagged<T>[]> tC ){
	...
	public PopulationSearch<T,R> HAEA( int mu, HaeaOperators<T> operators, Selection<T> selection, Predicate<Tagged<T>[]> tC ){
		return HAEA( new NSHaeaStep<T,R>(mu,selection,operators), tC );
	}
	...
	public PopulationSearch<T,R> HAEA( NSHaeaStep<T,R> step, int MAXITERS ){
		...
		return HAEA( new NSHaeaStep<T,R>(mu,selection, operators, false), MAXITERS );
	}	
}