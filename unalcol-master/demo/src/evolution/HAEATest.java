...
public class HAEATest {
	...
	public static void real(){
		...
		int POPSIZE = 100;
		int MAXITERS = 100;
		EAFactory<double[],Double> factory = new EAFactory();
	...
	public static void binary(){
		...
		// Variation definition
    		...
    		int POPSIZE = 100;
    		int MAXITERS = 10;
    		EAFactory<BitArray,Double> factory = new EAFactory();
	...
	public static void binary2real(){
		...
		int POPSIZE = 100;
		int MAXITERS = 10;
		EAFactory<BitArray,Double> factory = new EAFactory<BitArray,Double>();
