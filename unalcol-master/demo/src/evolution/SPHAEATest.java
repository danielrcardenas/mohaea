...
public class SPHAEATest {
    ...
    public static void real() {
        ...
        int POPSIZE = 100;
        int MAXITERS = 250;
        SPHaeaFactory<double[], Double[]> factory = new SPHaeaFactory<>();
