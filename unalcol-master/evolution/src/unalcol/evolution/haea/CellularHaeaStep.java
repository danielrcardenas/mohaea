 ...
 *
 */
public class CellularHaeaStep<T,R> extends HaeaStep<T,R> {
    /**
     ...
     */
    public CellularHaeaStep(int mu,  Selection<T> selection, HaeaReplacement<T,R> replacement) {
     ...
     * @param space Replacement mechanism
     */
    @Override
